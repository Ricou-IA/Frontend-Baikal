...
import { buildNamedTargets, mergeTargeted, targetLabel, annotateTargeted, slimNamedDocuments, TARGETED_HIERARCHY_LEVELS } from "./targeted.ts"
...
Deno.test("TARGETED_HIERARCHY_LEVELS couvre L0+L1 : un document nommé doit remonter quel que soit son niveau de hiérarchie", () => {
  assertEquals(TARGETED_HIERARCHY_LEVELS, [0, 1])
})
